          ...
          <div className="mt-12 lg:col-span-2 lg:m-0 lg:pl-8">
            <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0 lg:py-20">
              <blockquote>
                <div>
                  <svg
                    className="h-12 w-12 text-indigo-900 opacity-25"
                    fill="currentColor"
                    viewBox="0 0 32 32"
                    aria-hidden="true"
                  >
                ...
                <footer className="mt-6">
                  <p className="text-base font-medium text-indigo-900">Judith Black</p>
                  <p className="text-base font-medium text-indigo-800">CEO at PureInsights</p>
                </footer>
              </blockquote>
            </div>
          </div>
